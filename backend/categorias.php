...
if (isset($_POST['accion']) && $_POST['accion'] == 'guardar' && trim($_POST['nombre']) <> ''){
    $img = '';
    if (isset($_FILES['imagen']['tmp_name']) && !empty($_FILES['imagen']['tmp_name'])){
        ...
        $base_guardar = dirname(__FILE__, 2).DIRECTORY_SEPARATOR."uploads".DIRECTORY_SEPARATOR."categorias".DIRECTORY_SEPARATOR;
